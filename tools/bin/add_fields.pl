...
# The output files overwrite the input files.

# Usage:
# add_fields.pl filename col1_1:col1_2,col2_1:col2_2,...

# For example, to add columns 3,4,and 5 together, and to add columns 7 and 8 together:
# add_fields.pl filename 3:4:5,7:8
